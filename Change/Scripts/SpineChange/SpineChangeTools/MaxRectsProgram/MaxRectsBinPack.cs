...
public class MaxRectsBinPack
{
    ...
    {
        RectBestShortSideFit,    ///将矩形放置在自由矩形的短边上，使其最适合。
        RectBestLongSideFit,     ///将矩形放置在一个自由矩形的长边上，使其最适合其中。
        RectBestAreaFit,         ///将矩形定位到它所适合的最小的自由矩形中。
        RectBottomLeftRule,      ///俄罗斯方块的位置。
        RectContactPointRule     ///尽量选择矩形与其他矩形接触的位置。
    };
